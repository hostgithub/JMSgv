...
public class ShiZhangDetailActivity extends BaseActivity
{
...
//                LinearLayout.LayoutParams.FILL_PARENT);
    ...
    private void getData(){        //json格式有问题 解析失败
        ...
        Call<SqgkDetail> call=api.getMayorSecretaryData("郭冀平");
        call.enqueue(new Callback<SqgkDetail>() {
            ...
            public void onResponse(Call<SqgkDetail> call, Response<SqgkDetail> response) {
                if(response!=null){
                    ...
                    Toast.makeText(ShiZhangDetailActivity.this,"服务器暂未响应!",Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<SqgkDetail> call, Throwable t) {
                Toast.makeText(ShiZhangDetailActivity.this,"请求失败!",Toast.LENGTH_SHORT).show();
