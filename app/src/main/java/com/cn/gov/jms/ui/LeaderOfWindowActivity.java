...
public class LeaderOfWindowActivity extends BaseActivity {
...
//        mRecyclerView.setAdapter(sqgkAdapter);
    ...
    private void initBannerData() {
        ...
        Call<AboutAndContact> call=api.getLeaderOfWindowData();
        call.enqueue(new Callback<AboutAndContact>() {
            ...
            public void onResponse(Call<AboutAndContact> call, Response<AboutAndContact> response) {
                if(response!=null){
                    ...
                    leaderOfWindowAdapter = new LeaderOfWindowAdapter(LeaderOfWindowActivity.this, list);
                    ...
                    leaderOfWindowAdapter.setOnItemClickLitener(new LeaderOfWindowAdapter.OnItemClickListener() {
                        ...
                        public void onItemClick(int position) {
                            //getData(list.get(position).id); 不在本页面请求
                            Intent intent = new Intent(LeaderOfWindowActivity.this,LeaderOfWindowListActivity.class);
                            intent.putExtra(Config.NEWS,list.get(position).id);
                            startActivity(intent);
                        }
                    });
                }else{
                    Toast.makeText(LeaderOfWindowActivity.this,"数据为空!",Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<AboutAndContact> call, Throwable t) {
                Toast.makeText(LeaderOfWindowActivity.this,"请求失败!",Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        call.enqueue(new Callback<AboutAndContact>() {
            ...
            public void onResponse(Call<AboutAndContact> call, Response<AboutAndContact> response) {
                if(response!=null){
                    ...
                    Intent intent = new Intent(LeaderOfWindowActivity.this,LeaderOfWindowListActivity.class);
                    intent.putExtra(Config.NEWS,detail);
                    startActivity(intent);
                    Log.e("xxxxxxx",detail.getResults().toString());
                }else{
                    Toast.makeText(LeaderOfWindowActivity.this,"数据为空!",Toast.LENGTH_SHORT).show();
                }
            }
