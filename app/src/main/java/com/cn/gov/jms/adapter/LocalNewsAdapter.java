...
public class LocalNewsAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public LocalNewsAdapter(Context context, ArrayList<NewCenter.ResultsBean> datas) {
        this.datas = datas;
