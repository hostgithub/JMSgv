...
public class GovFileActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener {
...
//        Call<Gongzuonianbao> call=api.getGongzuonianbaoData("0001000200030001",pages);//老表里面的
        ...
        call.enqueue(new Callback<Gongzuonianbao>() {
            ...
            public void onFailure(Call<Gongzuonianbao> call, Throwable t) {
                Toast.makeText(GovFileActivity.this,"请求失败!",Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        call.enqueue(new Callback<Detail>() {
            ...
            public void onResponse(Call<Detail> call, Response<Detail> response) {
                if(response!=null){
                    ...
                    Intent intent = new Intent(GovFileActivity.this,DetailActivity.class);
                    intent.putExtra(Config.NEWS,resultsBean);
                    startActivity(intent);
                    Log.e("xxxxxxx",resultsBean.content);
                }else{
                    Toast.makeText(GovFileActivity.this,"数据为空!",Toast.LENGTH_SHORT).show();
                }
            }
